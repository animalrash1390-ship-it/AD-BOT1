    ...
    def get_message(self, key, **kwargs):
        messages = {
            "fa": {
                ...
                "invalid_command": "❌ دستور نامعلوم! برای دیدن دستورات بات !help استفاده کنید یا به @MR._.MOHAMMAD پیام بدید.",
...
async def main():
    ...
    room_id = os.getenv("ROOM_ID", "692093cc8cae7fc19b33d589")
    api_token = os.getenv("API_TOKEN", "2e3d6601390ee42778271b9a84036ed6123d2d752b056495e0c93a1b0629fdf1")
